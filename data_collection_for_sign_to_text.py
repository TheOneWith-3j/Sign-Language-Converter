...
count = len(oss.listdir("D:\\Projects\\SIGN language conversion using youtube transcripts\\AtoZ_3.1\\A\\"))
c_dir = 'A'
...
cv2.imwrite("D:\\Projects\\SIGN language conversion using youtube transcripts\\white.jpg",white)
