...
class Application:
    ...
    def __init__(self):
        ...
        self.panel.place(x=100, y=3, width=550, height=480)
        self.panel.config(bg="#B4CFEC")


        self.panel2 = tk.Label(self.root)  # initialize image panel
        self.panel2.place(x=700, y=150, width=350, height=250)
        self.T = tk.Label(self.root)
        self.T.place(x=60, y=5)
        self.T.config(text="Sign Language To Text Conversion", font=("Arial", 15, "bold"))

        self.panel3 = tk.Label(self.root)  # Current Symbol
        self.panel3.place(x=260, y=425)

        self.T1 = tk.Label(self.root)
        self.T1.place(x=10, y=425)
        self.T1.config(text="Character :", font=("Arial", 20, "bold"))
        ...
        self.T3.config(text="Sentence :", font=("Arial", 20, "bold"))

        self.T4 = tk.Label(self.root)
        self.T4.place(x=10, y=550)
        self.T4.config(text="Suggestions :", fg="green", bg='yellow',font=("Arial", 15, "bold"))


        self.b1=tk.Button(self.root)
        self.b1.place(x=310,y=550)

        self.b2 = tk.Button(self.root)
        self.b2.place(x=510, y=550)

        self.b3 = tk.Button(self.root)
        self.b3.place(x=710, y=550)

        self.b4 = tk.Button(self.root)
        self.b4.place(x=910, y=550)

        self.speak = tk.Button(self.root)
        self.speak.place(x=1105, y=400)
        self.speak.config(text="Speak", font=("Arial", 15, "bold"),bg='light pink', fg = 'navy blue', wraplength=100, command=self.speak_fun)

        self.clear = tk.Button(self.root)
        self.clear.place(x=1105, y=550)
        self.clear.config(text="Clear", font=("Arial", 15, "bold"),bg='light pink', fg = 'navy blue', wraplength=100, command=self.clear_fun)
    ...
    def video_loop(self):
        try:
            ...
            if hands:
                ...
                white = cv2.imread("D:\\Projects\\SIGN language conversion using youtube transcripts\\white.jpg")
                ...
                if handz:
                    ...
                    self.panel3.config(text=self.current_symbol, font=("Arial Black", 15))

                    #self.panel4.config(text=self.word, font=("Arial Black", 30))



                    self.b1.config(text=self.word1, font=("Arial", 15, "bold"), wraplength=825, command=self.action1)
                    self.b2.config(text=self.word2, font=("Arial", 15, "bold"), wraplength=825,  command=self.action2)
                    self.b3.config(text=self.word3, font=("Arial", 15, "bold"), wraplength=825,  command=self.action3)
                    self.b4.config(text=self.word4, font=("Arial", 15, "bold"), wraplength=825,  command=self.action4)

            self.panel5.config(text=self.str, font=("Arial Black", 15), wraplength=1025)
        except Exception:
